...
public void thongKeSp1(JPanel jpanItem){
    ...
    if (list!= null) {
        ...
        for (ThongKe thongKe : list) {
            dataset.addValue(thongKe.getSoLuongBan(), "Số lượng bán", thongKe.getGiaBan());
        }
        JFreeChart tree  = ChartFactory.createBarChart("Thống kê sản phẩm", "Giá bán", "Số lượng bán", dataset);
        ChartPanel chartPanel = new ChartPanel(tree);
        chartPanel.setPreferredSize(new Dimension(jpanItem.getWidth(),0));
 ...
 public void thongKeSp2(JPanel jpnItem) {
        ...
        JFreeChart ganttChart = ChartFactory.createGanttChart(
                ...
                "Tên sản phẩm", "Só lương bán", ds, true, false, false
        );
        ...
        if (listItem != null) {
            for (ThongKe item : listItem) {
                ...
                task = new Task(item.getTenSP(), new SimpleTimePeriod(item.getSoLuonTon(), item.getSoLuongBan()));
                taskSeries.add(task);
                ds.add(taskSeries);
            }
        }
        ChartPanel chartPanel = new ChartPanel(ganttChart);
        chartPanel.setPreferredSize(new Dimension(jpnItem.getWidth(), 30));
    ...
    private void initComponents() {
        ...
        cboHangXe.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Hãng xe", " " }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Trạng thái cũ mới", " " }));

        jLabel3.setText("Chọn hình thức thống kê");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cboHangXe, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tblTkSP.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã sản phẩm", "Tên sản phẩn", "Năm sản xuất", "Số lượng tồn", "Giá nhập(TRIỆU)", "Giá bán(TRIỆU)", "Số lượng bán", "Doanh thu(TRIỆU)"
            }
        ) {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(excelSp, javax.swing.GroupLayout.Alignment.TRAILING))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void excelSpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelSpActionPerformed
        ...
        try {
            ...
            XSSFSheet sheet = xssf.createSheet("danhsach");
            XSSFRow row = null;
            Cell cell = null;
            ...
            for (int i = 0; i < listTk.size(); i++) {
                ...
                cell = row.createCell(5, CellType.STRING);
                cell.setCellValue(listTk.get(i).getGiaNhap());

                cell = row.createCell(6, CellType._NONE);
        ...
        JOptionPane.showMessageDialog(this, "In file excel thành công D:\\danhsach");
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewThongKe.class  
