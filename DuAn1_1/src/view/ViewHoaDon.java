...
public class ViewHoaDon extends javax.swing.JFrame {
    ...
    HopDongImpl hopDongImpl = new HopDongImpl();
    ...
    public ViewHoaDon() {
        ...
        String[] hearder = {"MaHD", "Ten xe", "ten nhan vien", "ten khach Hang", "Ngay tao", "ngay thanh toan", "dia chi", "sdt", "don gia", "so luong", " tong tien"};
        dtm.setColumnIdentifiers(hearder);
        listHD = hdSer.getAll();
        
    }

    public void loadTable(List<HopDongVD> listHD) {
...
//        dtm.setRowCount(0);
//        listHD.forEach(s -> dtm.addRow(s.toRowData()));
    }
    ...
    private void initComponents() {
        ...
        txtNameNV.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(txtMa, javax.swing.GroupLayout.DEFAULT_SIZE, 324, Short.MAX_VALUE)
                                    .addComponent(txtNameNV, javax.swing.GroupLayout.DEFAULT_SIZE, 324, Short.MAX_VALUE)
                                    .addComponent(txtTen)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(txtDonGia, javax.swing.GroupLayout.PREFERRED_SIZE, 324, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(492, 492, 492)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
...
//        lammoi();
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        String tenNV = txtNameNV.getText();
        ...
        HopDongVD hd = new HopDongVD(makh, tenXe, tenNV, tenKH, ngayTao, ngayThanhToan, Integer.parseInt(soLuong), Double.parseDouble(donGia), sdt, diaChi);
        if (makh.trim().equals("")) {
            JOptionPane.showMessageDialog(this, "không được để trống", "Invalidation", JOptionPane.ERROR_MESSAGE);
            return;
        } else {
            JOptionPane.showMessageDialog(this, hopDongImpl.Add(hd));
            listHD = hopDongImpl.getAll();
            loadTable(listHD);
        }
